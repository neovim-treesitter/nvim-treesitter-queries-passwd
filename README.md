# nvim-treesitter-queries-passwd

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-passwd/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-passwd/actions/workflows/validate.yml)

Neovim tree-sitter queries for **passwd**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-passwd",
...
- [ ] Changes are scoped to `passwd` — do not include files for other languages
